...
public class PrayTime {
    ...
    private double[] computeTimes(double[] times) {
        ...
        double[] CTimes = {Fajr, Sunrise, Dhuhr, Asr, Sunset, Maghrib, Isha, 0};
    ...
    private ArrayList<String> computeDayTimes() {
        double[] times = {5, 6, 12, 13, 18, 18, 18, 23}; // default times
        ...
        double Nimeshab = times[4] + (24-times[4] + times[0])/2;
        if(Nimeshab > 24)
        	Nimeshab = Nimeshab - 24;
    ...
    public static void main(String[] args) {
        double latitude = 49.4167;
        double longitude = 8.7167;
        double timezone = 1;
        ...
        int[] offsets = {0, 0, 0, 0, 0, 0, 0, 0}; // {Fajr,Sunrise,Dhuhr,Asr,Sunset,Maghrib,Isha, Nimeshab}
