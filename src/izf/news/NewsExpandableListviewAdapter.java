...
public class NewsExpandableListviewAdapter extends BaseExpandableListAdapter {
    ...
    private List<News> _listDataHeader; // header titles
    // child data in format of header title, child title
    private HashMap<News, List<String>> _listDataChild;
 
    public NewsExpandableListviewAdapter(Context context, List<News> listDataHeader,
            HashMap<News, List<String>> listChildData) {
